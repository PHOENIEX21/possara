...
import type { OpportunitySourceInfo } from "../hooks/useOpportunities";

interface OpportunityCardProps { opportunity: Opportunity & { opportunity_candidates?: { opportunity_sources: OpportunitySourceInfo | null } | null }; organization?: Pick<Organization, "name" | "verified" | "is_sponsored"> | null; category?: Pick<OpportunityCategory, "name" | "icon" | "color"> | null; }
