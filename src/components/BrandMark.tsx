export function BrandMark({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 52 48" className={className} aria-hidden="true">
      <defs>
        <linearGradient id="possara-top" x1="6" y1="7" x2="46" y2="20" gradientUnits="userSpaceOnUse">
      ...
      <path d="M10 6.5h23.5c7 0 12 4.1 12 9.7 0 5.5-5 9.7-12 9.7H19.3l7.6-8.2h6.6c1.8 0 2.8-.6 2.8-1.6 0-.9-1-1.5-2.8-1.5H10c-2.9 0-5-1.7-5-4.1s2.1-4 5-4Z" fill="url(#possara-top)"/>
