...
function StoryViewer({ group, onClose }: { group: AuthorWithStories; onClose: () => void }) {
  ...
  return <div className="fixed inset-0 z-[110] flex items-center justify-center bg-ink/95 sm:px-4">
