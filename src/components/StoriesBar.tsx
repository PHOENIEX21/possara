...
export function StoriesBar() {
  ...
  return (
    <div className="scrollbar-none flex gap-3 overflow-x-auto pb-1">
          ...
          <div className="relative h-14 w-14">
            ...
            {myGroup && (
              <button
                ...
                className="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-brand text-white shadow-sm"
      ...
      <input ref={fileInputRef} type="file" accept="image/*" onChange={handleAddStory} className="hidden" />
