 ...
 return <div className="feed-layout">
  <div className="feed-column">
   ...
   <section className="home-compose-section">
    <PostComposer placeholder="Share an idea, achievement, question or something useful…" showHomeTopicPicker/>
   </section>

   <section className="home-feed-heading home-feed-heading-premium">
    <div><p className="eyebrow">Community stream</p><h2>What people are sharing</h2><p>Real people, useful ideas, progress and things worth discovering.</p></div>
  ...
  <aside className="feed-rail">
   ...
   <div className="rail-card"><p className="text-sm font-semibold">Learn when you need to.</p><p>POSSARA Study stays separate from the social stream so learning remains focused.</p><Link to="/study" className="rail-link">Open Study <ArrowUpRight size={14}/></Link></div>
  </aside>
 </div>
}
