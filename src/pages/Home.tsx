...
import { ArrowUpRight, Briefcase, Building2, MapPin, Sparkles } from "lucide-react";
...
export function Home(){
  ...
  return <div className="feed-layout">
    <div className="feed-column">
      ...
      <Link to="/places" className="home-places-entry">
        <span className="home-places-icon"><MapPin size={18}/></span>
        <span className="home-places-copy"><strong>Explore interesting places</strong><small>Discover remarkable places without mixing them into your Home feed.</small></span>
        <ArrowUpRight size={16} className="home-places-arrow"/>
      </Link>
